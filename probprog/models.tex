...
that suitable measures exist~\cite{staton2016semantics}.  In particular,
...
dictates where $x_{j+1}$ exists, it is not possible to have $\mathcal{B}(x_{1:n_x},\lambda)=\mathcal{B}(x_{1:j},\lambda)=1$,
...
both the outputs $[2.3,3.5]$ and $[2.3,3.5,1.2]$, remembering that $\xnx$ relates to the raw
outputs of the \sample statements.
