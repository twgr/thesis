...
Using this idea of execution paths, we can define an expression for the joint probability a program defines,
...
So why does this really matter? .... \todo[inline]{Give an example program}
