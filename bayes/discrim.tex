...
is \emph{independent} given the class label.  As such it reasons about the distribution over both
...
This freedom is both a blessing and a curse: it allows us to impart our own knowledge about the problem on
...
Further, even after the forms of $p(x^i |y)$ and $p(y)$ have been defined, there are still decisions to be
