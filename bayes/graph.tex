...
A key part to the appeal of HMMs is that the structure of the
...
for tractability, e.g. by using an off-the-shelf model like a HMM with known analytic solution. Though often necessary, 
...
of tractability in the first place.  The is a serious practical weakness of Bayesian modeling and should be factored in
to the decision processes of whether taking a Bayesian approach or not.  While taking a Bayesian approach for large projects, 
