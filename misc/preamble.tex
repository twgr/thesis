...
\title{\vspace{30pt}Automating Inference, Learning, and Design \\ using Probabilistic Programming}
...
\lstset{ 
	...
	keywords=[4]{defopt,defquery,doopt,doquery,query,defdist,infer,checkpoint,exec,defm,conditional},
