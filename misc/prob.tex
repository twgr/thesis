...
that we roll a number less than $7$.  All probabilities much thus lie (inclusively) between $0$ and $1$.  
...
number of possible outcomes.\footnote{Technically speaking, discrete random variables can also
	...
	over $0,1,2,\dots,\infty$ and is a discrete distribution with infinite possible outcomes.  
