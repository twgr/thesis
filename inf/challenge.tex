...
key underlying, before introducing a number of foundational methods that form the building blocks
for more advanced strategies such as those discussed in Chapter~\ref{chp:part}.  We will later
...
we now have the exact form of the posterior using in Bayes' rule.  Unfortunately, it tends to
...
to directly sampling from it without doing further calculations.  For example, if
