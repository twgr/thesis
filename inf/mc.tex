...
As a consequence, $\sigma_N^2 \asto \sigma$ by the strong LLN, from which the second result
...
setting.  This is critical for proving the convergence of the numerous \mc inference schemes, such
as all MCMC methods, that
do not produce independent samples but instead rely on the samples converging in distribution
to the target.  It is beyond the scope of this thesis to go into these more general forms of the CLT
